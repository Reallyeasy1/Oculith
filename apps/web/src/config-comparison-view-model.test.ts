...
describe("historical reliability comparison rows (#174)", () => {
  it("keeps telemetry and evaluation distinct and renders raw b-minus-a deltas", () => {
    const report = {
      ...
      a: { configHash: "cfg-a", runs: 2, executionCompletionRate: 1, taskCompletionRate: { evaluatorId: "task_completion", version: 1, evaluated: 2, passed: 2, rate: 1 }, toolFailureRate: 0.25, avgToolCalls: 4, tokens: { avgInput: 100, avgOutput: 20, sum: 240, sampled: 2 }, latency: { p50: 1000, p95: 2000, sampled: 2 }, denialRate: 0.5, cost: { avg: 0.02, sum: 0.04, sampled: 2 }, series: [], provenance: { count: 2, runIds: ["a1", "a2"], filter: { agentId: "agent-1", configHash: "cfg-a" } } },
      b: { configHash: "cfg-b", runs: 2, executionCompletionRate: 0.5, taskCompletionRate: { evaluatorId: "task_completion", version: 1, evaluated: 2, passed: 1, rate: 0.5 }, toolFailureRate: 0, avgToolCalls: 6, tokens: { avgInput: 120, avgOutput: 30, sum: 300, sampled: 2 }, latency: { p50: 800, p95: 1500, sampled: 2 }, denialRate: 0, cost: { avg: 0.03, sum: 0.06, sampled: 2 }, series: [], provenance: { count: 2, runIds: ["b1", "b2"], filter: { agentId: "agent-1", configHash: "cfg-b" } } },
      deltas: { runs: 0, executionCompletionRate: -0.5, taskCompletionRate: -0.5, toolFailureRate: -0.25, avgToolCalls: 2, tokens: { avgInput: 20, avgOutput: 10, sum: 60 }, latency: { p50: -200, p95: -500 }, denialRate: -0.5, cost: { avg: 0.01, sum: 0.02 } },
