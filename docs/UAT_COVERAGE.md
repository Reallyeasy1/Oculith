...
_What has been tested, how, and what has not. Last updated 31 August 2026 (main `9510617`). Automated coverage comes from `npm run check` (unit tests, guard self-test, build) and the E2E lane (`npm run test:e2e`); manual coverage comes from the nine UAT rounds below. This record is updated at the end of every UAT round._
